...
export const QuizCreatorInputs = ({stepHandlers}) => {
    return (
        <React.Fragment>
            <InputLine name="name" type="text" placeholder="nazwa testu" icon="letter" wrapperClasses="c-quiz-creator__input-line" handleBlur={stepHandlers[0]} classes="js-quiz-creator-title-input"/>
