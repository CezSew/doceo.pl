        ...
        return (
            <div className="c-add-question-form c-add-question-form--unfolded js-add-question-form " data-form-id={form.id} key={`form${form.id}`}>
                <div className="c-add-question-form__question-input-wrapper">
                    ...
                    <input className="c-add-question-form__input add-question-form__input--active" type="text" name={`question-${form.id}`} placeholder="wpisz pytanie" onClick={(e) => handleInputClick(e)}/>
                </div>
                <div className="c-add-question-form__answers">
                    <div className="c-add-question-form__answer-line">
                        <input className="c-add-question-form__input add-question-form__input--active" type="text" name={`answer-${form.id}`} placeholder="wpisz odpowiedź" onClick={(e) => handleInputClick(e)}/>
