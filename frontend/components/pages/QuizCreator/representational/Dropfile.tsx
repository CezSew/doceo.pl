...
export const Dropfile = () => {
    ...
    return (
        <section className="c-quiz-creator-form__dropfile-wrapper">
            <div className="c-quiz-creator-form__dropfile-description-wrapper">
                <p className="c-quiz-creator-form__dropfile-description o-underlined">Dodaj test z pliku tekstowego</p>
                <p className="c-quiz-creator-form__dropfile-description">Test musi zawierać co najmniej 5 pytań. Struktura pliku powinna wyglądać następująco: pierwsza linia pliku jest pytaniem, następne cztery linie odczytaną zostaną jako odpowiedzi. Umieść plus przed poprawną odpowiedzią. Następne pytania nanoś analogicznie, od następnej linii następującej po czwartej odpowiedzi poprzedniego pytania.</p>
                <p className="c-quiz-creator-form__dropfile-description">Pobierz plik z szablonem: <a href="#">Kliknij tutaj</a></p>
            </div>
